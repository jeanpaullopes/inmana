defmodule InmanaWeb.SuprimentController do
  ...
  def create(conn, params) do
    ...
    ret = Inmana.Supriment.changeset(params) |> Ecto.Changeset.put_assoc(:restaurant, restaurant) |> Inmana.Repo.insert()
  ...
  def update(conn, params) do
    ret =  Inmana.Supriment |> Inmana.Repo.get(params["id"]) |> Inmana.Supriment.changeset(params) |> Inmana.Repo.update()
